...
insert into task (task_name, task_status, task_description, task_importance, deadline, personid) values
('Soita Matille', 'Avoin', 'Kerro miten toimitaan', (select id from importance where importance_value = '1' limit 1), '2016-08-13', (select id from person where username = 'testtiin')),
('Vastaa Pirjolle', 'Avoin', 'Vastaa Pirjon mailiin', (select id from importance where importance_value = '2' limit 1), '2016-08-15', (select id from person where username = 'testtiin')),
('TNL laskarit', 'Kesken', 'Tee TNL laskarit', (select id from importance where importance_value = '1' limit 1), '2016-08-10', (select id from person where username = 'testtaav'));
